...
public class VariableNamingConventionImpl implements VariableNamingConvention {
    ...
    /*
     * This is lower range for desired character while generating the variable or field name using random characters,
     * this represent lower 'a' in ASCII character set
     */
    private static final int DESIREDCHARLOWERBOUND = 97;
    /*
     * This is upper range for desired character while generating the variable or field name using random characters,
     * this represent lower 'z' in ASCII character set
     */
    ...
    private String randomFieldNameGenerator() {
        ...
        for (int i = 0; i < GENERATEDVARIABLENAMELENGTH; i++, randomNo = -1) {
            while (randomNo < DESIREDCHARLOWERBOUND || randomNo > DESIREDCHSRUPPERBOUND) {
